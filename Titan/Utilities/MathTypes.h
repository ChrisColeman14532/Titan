...
{
	constexpr float pi = 3.14159265358979323846264333832795f;
	...
	using m3x3 = DirectX::XMFLOAT3X3; // NOTE: DirectXMath does' not provide't have aligned 3x3 matrices
	using m4x4 = DirectX::XMFLOAT4X4;
	using m3x3a = DirectX::XMFLOAT4X4A;
#endif
}