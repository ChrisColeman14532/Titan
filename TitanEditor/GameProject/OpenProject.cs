...
namespace TitanEditor.GameProject
{
    ...
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\TitanEditor";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Titan\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Titan\Screenshot.png");
